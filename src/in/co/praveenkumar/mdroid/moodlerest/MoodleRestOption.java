...
public class MoodleRestOption {
	...
	public static final String FUNCTION_GET_COURSE_CONTENTS = "moodle_course_get_courses";// "core_course_get_contents";
	...
	public static final String FUNCTION_GET_SITE_INFO = "moodle_webservice_get_siteinfo";
